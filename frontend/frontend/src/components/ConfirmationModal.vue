        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    Kas olete kindel, et soovite seda muudatust teha?
                    </h1>
                    <button type="button" class="btn-close" :data-bs-target="target" aria-label="Close"></button>
                </div>
                <div class="modal-body">                
                    Palun kinnitage enda soov.
                </div>
